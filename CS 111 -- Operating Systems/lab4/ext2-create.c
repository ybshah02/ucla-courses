...
void write_root_dir_block(int fd) {
	...
	// create parent inode similar to lost_and_found_dir_block
	...
	// create lost+found directory inode
	...
	// create hello symbolic link inode
